...
```{r scatter_matrix, fig.cap="Figure 1. Scatterplot matrix of water temperature and predictors", echo=FALSE}
...
```{r scatter plot matrix 2, fig.cap="Figure 2. Scatterplot matrix of water temperature and predictors (log transformed)", echo=FALSE}
...
AS shown in Figure 2, after applying log transformations to elevation and flow, the overall patterns in the scatterplot matrix did not change much.
...
```{r boxplot, fig.cap="Figure 3: Stream Water Temperature by Income Group",  echo=FALSE}
